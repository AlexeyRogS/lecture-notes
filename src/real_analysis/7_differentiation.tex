...
\begin{document}
    ...
    \section{Higher Derivatives}\label{sec:higher-derivatives}
        ...
        We can carry on this way if the derivatives carry on being differentiable, and once the prime notation becomes unwieldy, we can write the $n$\ts{th} \textbf{derivative} of $f$ as $f^{(n)}$ or $\dv[n]{f}{x}$.
