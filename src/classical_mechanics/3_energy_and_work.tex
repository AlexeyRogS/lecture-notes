...
\begin{document}
    ...
    \section{The Conservation of Energy}
        ...
        \begin{example}[The Epitaph of Stevinus]
            ...
            The first way by analysing the forces as we have learned in chapter~\ref{chap:1}, the second way using energy conservation, and the third way using a clever 16\ts{th} century thought experiment.
    ...
    \section{Work}
        ...
        \end{example}
        % TODO: add formulae for 3D polar coordinates
    ...
    \section{Conservative Forces}
        ...
        \end{equation}
        and so on.
        % TODO: add excersize for some coordinate system
